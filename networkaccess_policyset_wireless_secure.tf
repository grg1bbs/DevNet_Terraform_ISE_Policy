...
## Create Corp Wireless AuthZ Policy Rule 1 - AD User

resource "ise_network_access_authorization_rule" "authz_wireless_ad_user" {
  depends_on = [
    ise_network_access_policy_set.ps_wireless_secure,
...
resource "ise_network_access_authorization_rule" "authz_wireless_ad_computer" {
  depends_on = [
    ise_network_access_policy_set.ps_wireless_secure,
    ise_network_access_authorization_rule.authz_wireless_ad_user,
    ise_active_directory_add_groups.ad_domain_groups,
